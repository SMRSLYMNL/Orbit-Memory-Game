...
public class Mode_8_to_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mode_8_to_5);
        ...
        final TypedArray styledAttributes = Mode_8_to_5.this.getTheme().obtainStyledAttributes(
        ...
        height -= dpToPx(16, Mode_8_to_5.this);
        width -= dpToPx(10, Mode_8_to_5.this);

        int sideOfSquare = Math.min(height / 8, width / 5);
    ...
    public void imageClicked(final View view)
    {
        ...
        else if(count % 2 == 0)
        {
            if(positions[k] == positions[opened])
            {
                ...
                if(countPair == size)
                {
                    Toast.makeText(Mode_8_to_5.this, "CONGRATULATIONS!!!",Toast.LENGTH_SHORT).show();
