...
public class Mode_4_to_3 extends AppCompatActivity {
    ...
    int currentPos = -1;
    final int size = 12;
    ImageView childs[] = new ImageView[12];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mode_4_to_3);
        ...
        final TypedArray styledAttributes = Mode_4_to_3.this.getTheme().obtainStyledAttributes(
        ...
        height -= dpToPx(40, Mode_4_to_3.this);
        width -= dpToPx(40, Mode_4_to_3.this);

        height -= dpToPx(24, Mode_4_to_3.this);
        width -= dpToPx(18, Mode_4_to_3.this);

        int sideOfSquare = Math.min(height / 4, width / 3);
    ...
    public void imageClicked(final View view)
    {
        ...
        else if(count % 2 == 0)
        {
            if(positions[k] == positions[opened])
            {
                ...
                if(countPair == size)
                {
                    Toast.makeText(Mode_4_to_3.this, "CONGRATULATIONS!!!",Toast.LENGTH_SHORT).show();
