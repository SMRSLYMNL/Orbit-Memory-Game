...
public class Mode_4_to_4 extends AppCompatActivity {
    ...
    int currentPos = -1;
    final int size = 16;
    ImageView childs[] = new ImageView[16];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mode_4_to_4);
        ...
        final TypedArray styledAttributes = Mode_4_to_4.this.getTheme().obtainStyledAttributes(
        ...
        height -= dpToPx(20, Mode_4_to_4.this);
        width -= dpToPx(20, Mode_4_to_4.this);

        height -= dpToPx(24, Mode_4_to_4.this);
        width -= dpToPx(24, Mode_4_to_4.this);

        int sideOfSquare = Math.min(height / 4, width / 4);
    ...
    public void imageClicked(final View view)
    {
        ...
        else if(count % 2 == 0)
        {
            if(positions[k] == positions[opened])
            {
                ...
                if(countPair == size)
                {
                    Toast.makeText(Mode_4_to_4.this, "CONGRATULATIONS!!!",Toast.LENGTH_SHORT).show();
