...
public class Mode_6_to_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mode_6_to_4);
        ...
        final TypedArray styledAttributes = Mode_6_to_4.this.getTheme().obtainStyledAttributes(
        ...
        height -= dpToPx(24, Mode_6_to_4.this);
        width -= dpToPx(16, Mode_6_to_4.this);

        int sideOfSquare = Math.min(height / 6, width / 4);
    ...
    public void imageClicked(final View view)
    {
        ...
        else if(count % 2 == 0)
        {
            if(positions[k] == positions[opened])
            {
                ...
                if(countPair == size)
                {
                    Toast.makeText(Mode_6_to_4.this, "CONGRATULATIONS!!!",Toast.LENGTH_SHORT).show();
