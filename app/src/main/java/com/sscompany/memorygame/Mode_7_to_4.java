...
public class Mode_7_to_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mode_7_to_4);
        ...
        final TypedArray styledAttributes = Mode_7_to_4.this.getTheme().obtainStyledAttributes(
        ...
        int sideOfSquare = Math.min(height / 7, width / 4);
    ...
    public void imageClicked(final View view)
    {
        ...
        else if(count % 2 == 0)
        {
            if(positions[k] == positions[opened])
            {
                ...
                if(countPair == size)
                {
                    Toast.makeText(Mode_7_to_4.this, "CONGRATULATIONS!!!",Toast.LENGTH_SHORT).show();
