...
public class Mode_6_to_6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mode_6_to_6);
        ...
        final TypedArray styledAttributes = Mode_6_to_6.this.getTheme().obtainStyledAttributes(
        ...
        height -= dpToPx(12, Mode_6_to_6.this);
        width -= dpToPx(12, Mode_6_to_6.this);

        int sideOfSquare = Math.min(height / 6, width / 6);
    ...
    public void imageClicked(final View view)
    {
        ...
        else if(count % 2 == 0)
        {
            if(positions[k] == positions[opened])
            {
                ...
                if(countPair == size)
                {
                    Toast.makeText(Mode_6_to_6.this, "CONGRATULATIONS!!!",Toast.LENGTH_SHORT).show();
